...
\email{roman.prokofyev@exascale.info}                      % optional, remove the line if not wanted
...
\cvline{\textbf{Research interests}}{\emph{semantic web, ontology construction, knowledge extraction, text classification, word sense disambiguation}}
\cvline{\textbf{Technologies}}{\emph{python, java, django, jquery, mysql, postgres, nginx, memcached, git, hadoop, jenkins, scss, css, html5}}
...
\textbf{Keywords: }{\emph{word sense disambiguation, machine learning, natural language processing, ontology learning, semantic web, nltk, scikit-learn, python, django}}
\\\\
...
My research is focused on developing new methods that provide knowledge extraction from unstructured technical data as well as knowledge processing and discovery.
\\\\
More information and the full list of my publications is available at:\\\href{http://exascale.info/members/roman_prokofyev}{http://exascale.info/members/roman\_prokofyev}
}%
...
\item Introduced Continuous Integration system based on \href{http://jenkins-ci.org}{Jenkins CI}
\end{itemize}
\vspace{0.3cm}
...
\cventry{May 2012 -- Present}{Farplano (Swiss Stationboards)}{\href{https://play.google.com/store/apps/details?id=com.schedulr}{app on Google Play}}{}{}{
...
\\
More on the development process, different app versions and data analytics:\\ \href{http://prokofyev.ch/categories/stationboards-app.html}{prokofyev.ch/categories/stationboards-app.html}
\\
}%
